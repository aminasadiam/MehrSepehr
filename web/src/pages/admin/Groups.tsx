...
const Groups: Component = () => {
  ...
  const addProduct = async (groupId: number) => {
    ...
    try {
      ...
      console.error(e);
      const errMsg = e.message || "خطا در افزودن محصول به گروه";
      alert(`خطا: ${errMsg}`);
    }
  };
  ...
  const addUser = async (groupId: number) => {
    ...
    try {
      ...
      console.error(e);
      const errMsg = e.message || "خطا در افزودن کاربر به گروه";
      alert(`خطا: ${errMsg}`);
    }
  };
  ...
  return (
    <div dir="rtl" class="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-sky-50">
        ...
        <div class="sticky top-0 z-10 bg-linear-to-r from-blue-600 via-blue-700 to-blue-800 text-white p-8 rounded-2xl border-b-4 border-blue-900 mb-8 shadow-lg">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-blue-100 mt-2">ایجاد و مدیریت گروه‌ها، محصولات و کاربران</p>
            </div>
            <button
              onClick={() => {
                resetForm();
        ...
        fallback={
          <div class="flex items-center justify-center py-12">
            <div class="text-center">
              ...
              <div class="text-lg text-slate-600">در حال بارگذاری گروه‌ها...</div>
            </div>
          </div>
        }
      >
        <Show
          ...
          fallback={
            <div class="bg-white rounded-2xl shadow-sm border-2 border-slate-200 p-12 text-center">
              ...
              <h3 class="text-2xl font-bold text-slate-800 mb-2">گروهی یافت نشد</h3>
              <p class="text-slate-600 mb-6">هنوز گروهی ایجاد نشده است. برای شروع، یک گروه جدید ایجاد کنید.</p>
              <button
                onClick={() => {
                  resetForm();
                  setShowCreate(true);
                  ...
                  <div class="p-5 space-y-5">
                    ...
                    <div>
                      <div class="flex items-center gap-2 mb-3">
                        ...
                        <h4 class="font-bold text-slate-900 uppercase tracking-wide text-sm">محصولات</h4>
                    ...
                    <div class="border-t border-slate-200 pt-5">
                      <div class="flex items-center gap-2 mb-3">
                        <span class="text-lg">👤</span>
                        <h4 class="font-bold text-slate-900 uppercase tracking-wide text-sm">کاربران</h4>
